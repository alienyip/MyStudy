...
import com.example.android.imagepicker.adapter.SmallPreviewAdapter
import com.example.android.imagepicker.bean.ImageItem
import kotlinx.android.synthetic.main.activity_image_preview.*
import kotlinx.android.synthetic.main.include_top_bar.*

class ImagePreviewActivity : ImagePreviewBaseActivity() , View.OnClickListener{
        ...
        cb_check.setOnClickListener {
            ...
            if (cb_check.isChecked) {
                if (pickHelper.canSelect()) {
                    ...
                    Toast.makeText(this, getString(R.string.ip_select_limit, pickHelper.limit), Toast.LENGTH_SHORT).show()
