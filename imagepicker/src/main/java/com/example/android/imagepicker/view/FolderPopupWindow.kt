...
/**
 * Created by Nature on 2017/12/1.
 */
class FolderPopupWindow(context: Context, adapter: BaseAdapter) : PopupWindow(context), View.OnClickListener {
    ...
    init {
        ...
        listView.onItemClickListener = AdapterView.OnItemClickListener { adapterView, v, position, l -> onItemClickListener?.onItemClick(adapterView, v, position, 1) }
    }
